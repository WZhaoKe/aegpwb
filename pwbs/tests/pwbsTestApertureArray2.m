function [ isPass ] = pwbsTestApertureArray2()
% pwbsTestApertureArray2 - 
%
...
% Date: 06/03/2017
  ...
  pwbm = pwbsAddAperture( pwbm , 'AP1' , 'C1' , 'C2' , 1 , 'CircularArray' , { arrayArea , arrayPeriodX , arrayPeriodY , unitCellArea , thickness , radius } );
