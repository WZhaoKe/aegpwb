function [ isPass ] = pwbsTestApertureArray4()
% pwbsTestApertureArray4 - 
%
...
% Date: 06/03/2017
  ...
  pwbm = pwbsAddAperture( pwbm , 'AP1' , 'C1' , 'C2' , 1 , 'SquareArray' , { arrayArea , arrayPeriodX , arrayPeriodY , unitCellArea , thickness , side } );
