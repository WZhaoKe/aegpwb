...
%
% pwbLaminatedSphere_PenaPalM - Mie absorption cross-sections of a multi-layer lossy sphere.
%                              using Pena and Pal's MATLAB code [1].
%
% [ ACS , AE ] = pwbLaminatedSphere_PenaPalM( f , area , radii , eps_r , sigma , mu_r )
%
%              /   /  /        /
%             |   |   |       |
