...
% Date: 01/09/2016
  ...
  if( a_x == b_y )
    ...
    [ area , alpha_mxx , alpha_myy , alpha_ezz ] = pwbApertureCircularPol( a_x );
    ...
    if( b_y < a_x )
      ...
      [ K , E ] = ellipke( eccentricity^2 );
      alpha_ezz = pi / 3.0 * a_x * b_y^2 / E;
      alpha_myy = pi / 3.0 * a_x^3 * eccentricity^2 / ( K - E );
      alpha_mxx = pi / 3.0 * a_x^3 * eccentricity^2 / ( ( 1.0 / aspect )^2 * E - K );
    end % if
