...
%
% pwbLaminatedSphere_PenaPal - Mie absorption cross-sections of a multi-layer lossy sphere.
%                              using Pena and Pal's scattnlay C code [1].
%
% [ ACS , AE ] = pwbLaminatedSphere_PenaPal( f , area , radii , eps_r , sigma , mu_r )
%
%              /   /  /        /
%             |   |   |       |
